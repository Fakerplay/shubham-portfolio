...
export const DETAILED_PROJECTS: Record<string, DetailedProject> = {
  "daulat-finvest": {
    ...
    subtitle: "A clearer digital wealth experience for understanding assets, tracking performance, and staying connected with an advisor.",
  ...
  "solaris": {
    ...
    subtitle: "A distinctive brand and visual system spanning identity, 3D imagery, digital products, campaigns, and investor communication.",
    year: "2024 - 2025",
  ...
  "optiv": {
    ...
    subtitle: "A scalable identity built to remain recognizable across digital interfaces, physical applications, and campaign touchpoints.",
    year: "2025",
  ...
  "studio-vistara": {
    ...
    subtitle: "Translating an architecture studio's spatial sensibility into a tactile identity across print, presentation, and digital formats.",
    year: "2025 - Present",
  ...
  "solace": {
    ...
    subtitle: "A restrained identity and packaging system built around editorial typography, tactile materials, and a calmer expression of premium wellness.",
    year: "2025",
